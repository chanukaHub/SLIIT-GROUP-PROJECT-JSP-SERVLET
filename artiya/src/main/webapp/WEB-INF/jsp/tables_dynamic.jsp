    ...
    <div class="main_container">
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="Dashboard" class="site_title"><i class="fa fa-paw"></i> <span>Four Season!</span></a>
                </div>
        ...
        <footer>
            <div class="pull-right">
                Copyright © Employee Management 2018.<a href="https://colorlib.com">Created by Rivindu Wijayarathna</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
